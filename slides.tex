...
\mode<beamer>{
	\centering
	\onslide<1>{\includegraphics[width=.55\linewidth, clip, trim={0 0 0 2cm}]{example-trees-good1-loo-annotated-1.pdf}}
	\onslide<2>{\includegraphics[width=.55\linewidth, clip, trim={0 0 0 2cm}]{example-trees-good1-loo-annotated-2.pdf}}
	\onslide<3>{\includegraphics[width=.55\linewidth, clip, trim={0 0 0 2cm}]{example-trees-good1-loo-annotated.pdf}}
}

\mode<handout>{
	\begin{figure}
		\centering\includegraphics[width=.55\linewidth, clip, trim={0 0 0 2cm}]{example-trees-good1-loo-annotated.pdf}
	\end{figure}
}
...
\begin{frame}
	\frametitle{Example 2: Poor quality prediction}
	
	\begin{figure}
		\centering
		\includegraphics[width=.6\linewidth]{example-trees-bad1-loo-annotated.pdf}
