...
%--------------------------------------------------------------------------------
\newcommand{\byside}[2]{\begin{minipage}[t]{.3\linewidth}%
		\centering%
...
\fbox{\uncover<2->{{\huge $\checkmark$}}} Higher convergence rate.\\
\fbox{\uncover<3->{{\huge $\checkmark$}}} Lower Type-I error rate.\\
\fbox{\uncover<4->{{\huge $\checkmark$}}} Smaller Bias.\\
\fbox{\uncover<5->{{\huge $\checkmark$}}} Improved power levels.\\
\fbox{\uncover<6->{{\huge $\checkmark$}}} Faster.\\
\fbox{\uncover<7->{{\huge $\checkmark$}}} More flexible.
