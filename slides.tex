...
\begin{figure}
	...
	\mode<beamer>{
	\only<1>{\input{fig/phylo-model-0.pdf_tex}}\only<2>{\input{fig/phylo-model-1.pdf_tex}}\only<3>{\input{fig/phylo-model-2a.pdf_tex}}\only<4-5>{\input{fig/phylo-model-2b.pdf_tex}}\only<6>{\input{fig/phylo-model.pdf_tex}}
...
\begin{minipage}[m]{.38\linewidth}
	...
	\begin{itemize}
		...
		\item \textcolor{innernode}{Loss\pause{} and gain \pause depend on: (a) state of the parent, and (b) the type of event (duplication or speciation)\hyperlink{duplicationvsspeciation}{\beamergotobutton{more}}}\pause
...
%--------------------------------------------------------------------------------
\begin{frame}[c]
	\frametitle{Conditional Probability: Mutual Ties}
...
%--------------------------------------------------------------------------------
\begin{frame}[c]
	\frametitle{Conditional Probability: Homophily}
	\begin{minipage}[b]{.7\linewidth}
		\begin{figure}
			\centering
			\def\svgwidth{.95\linewidth}
...
%--------------------------------------------------------------------------------
\begin{frame}[c]
	\frametitle{Conditional Probability: Transitive Triads}
\begin{minipage}[b]{.28\linewidth}
	\begin{figure}
