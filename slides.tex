...
\begin{frame}[t, label=ergmito-applied]
	\centering
	\mode<beamer>{
		\includegraphics<1>[width=.99\linewidth]{fig/ci-ergm-all-nets-wide.pdf}%
		\includegraphics<2>[width=.99\linewidth]{fig/ci-ergm-all-nets-wide-edges.pdf}%
		\includegraphics<3>[width=.99\linewidth]{fig/ci-ergm-all-nets-wide-transitivity.pdf}%
		\includegraphics<4>[width=.99\linewidth]{fig/ci-ergm-all-nets-wide.pdf}%
		\includegraphics<5>[width=.99\linewidth]{fig/ci-ergm-all-nets-wide-sender.pdf}%
		\includegraphics<6->[width=.99\linewidth]{fig/ci-ergm-all-nets-wide-all.pdf}
	}%
	\mode<handout>{
