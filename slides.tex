...
\begin{minipage}[m]{.38\linewidth}
	...
	\begin{itemize}
		...
		\item \textcolor{innernode}{Gain\pause{} and loss\pause{} \hyperlink{duplicationvsspeciation}{\beamergotobutton{more}}.}\pause
...
\begin{frame}[c,label=phylo-old-results]
	...
	\byside{Data driven}{%
		Uninformative (unif) priors provided the highest accuracy results%
	}\hfill
	\byside{Aligned with priors}{%
...
\begin{minipage}[m]{.28\linewidth}
	...
	\fbox{\uncover<5->{{\large $\checkmark$}}} Improved power levels.\\
...
\ultima{.3}{Before my dissertation}{%
	...
	\begin{itemize}
		...
		\item Small networks: underlooked.
...
6 journal publications (\tiny Journal of Open Source Software, Stata Journal, Journal of health and social behavior, Translational behavioral medicine, Social Science \& Medicine\small) \textbf{+2 on the queue}
...
\textbf{Other tools}\\
similR, gnet, aphylo, polygons, pruner, netplot, rphyloxml, jsPhyloSVG, and {\large \textbf{Barry}}
